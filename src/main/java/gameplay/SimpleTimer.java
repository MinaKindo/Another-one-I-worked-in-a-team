...
public class SimpleTimer extends Thread implements Timer {
   ...
   */
  /**
   * Removes time observer
   */
  public void removeTimeObserver(TimerObserver observer) {

    // this will work as long as we are passing the actual observer, and not an
    // equivalent
    // since TimerObserver does not include any indication of an ID, this should be
    // OK
