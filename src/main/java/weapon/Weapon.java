...
public interface Weapon extends TimerObserver {
   ...
   * 
   * @param distance the distance to the target, for now, if the target is in
   *                 range, it will be hit
  ...
  /**
   * reload the clip to full capacity. For now, we assume a limitless supply of
   * clips. This may be refactored in the future to take ammo reserves into
   * account.
   */
  public void reload();
