...
public class RecoveryFractional implements RecoveryBehavior {
  ...
  /**
   * @see recovery.RecoveryBehavior#calculateRecovery(int, int) recover the
   *      fractional amount of currentLife without exceeding maxLife fractional
   *      amount is always rounded up, for example, 10% of 9 points is 0.9. Amount
   *      to recover is 1 life point.
   */
